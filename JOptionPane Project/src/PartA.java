...
//	}
//
//	public static double width(double area, double ratio) {
//		double width = Math.sqrt(area / ratio);
//		return width;
//	}
//
//	public static double length(double ratio, double width) {
//		double length = ratio * width;
//		return length;
//	}
//	
...
//
// JOptionPane.showMessageDialog(null,
// "Your enclosure has dimensions " + df.format(length) + " feet by " +
// df.format(width)
// + " feet. You will need " + df.format(perimeter) + " feet of fence total.");
// }
// else
// {
// JOptionPane.showMessageDialog(null, "Please enter your input as <integer>
// <integer>. Make sure your values are integers greater than 0 and less than
// 100.");
// } // end ratioWidth else
//
// } //end ratioLength if
...
// {
// JOptionPane.showMessageDialog(null, "Please enter your input as <integer>
// <integer>. Make sure your values are greater than 0 and less than 100.");
// } // end ratioLength else
//
//
// }
// else
// {
// JOptionPane.showMessageDialog(null, "Please make sure your area is entered as
// a positive real number less than 1,000,000,000.");
// } // end area else
// }
// }
